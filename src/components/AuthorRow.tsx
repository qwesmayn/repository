  ...
  const [isEditingPosition, setIsEditingPosition] = useState(false);
    ...
    return (
      <tr key={author._id} className="flex transition-all justify-between duration-300 border-2 border-black mb-5 p-3">
        ...
        <td className="text-center align-top">
          <button
            className="bg-blue-500 shadow-dark-lg text-white px-2 py-3 rounded-2xl transition-colors duration-300"
            onClick={handleSave}
          >
            Зберегти зміни
          </button>
        ...
        <td className="text-center align-top">
          <button
            className="bg-red-500 shadow-dark-lg text-white px-2 py-3 rounded-2xl transition-colors duration-300"
